...
static func traits_match(entity_traits: Array, requirements) -> bool:
...
static func evaluate_modifier(
	...
	return {
		"modifier_type": modifier.get("modifier_type", ModifierType.FLAT_DAMAGE),
...
static func apply_modifiers_to_value(
	...
	for mod in modifiers:
		...
		match modifier_type:
			ModifierType.FLAT_DAMAGE, ModifierType.FLAT_HEALING:
				flat_bonus += value
			ModifierType.PERCENT_DAMAGE, ModifierType.PERCENT_HEALING:
